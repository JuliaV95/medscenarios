    ...
    export default {
        ...
        data() {
            return {
                icons: [
                    {
                        icon: require('@/assets/icons/complaints.svg'),
                        checked: false,
                    },
                    {
                        icon: require('@/assets/icons/anamnesis.svg'),
                        checked: false,
                    },
                    {
                        icon: require('@/assets/icons/anamnesis_vitae.svg'),
                        checked: false,
                    },
                    {
                        icon: require('@/assets/icons/objective.svg'),
                        checked: false,
                    },
                ],
            ...
            processButtonClick() {
                if (this.shouldDisplayAlert) {
                    this.showAlertNotification({
                        notificationText: 'Осмотр проведен не полностью',
                        greenStyle: false,
                        redStyle: true
                    })
